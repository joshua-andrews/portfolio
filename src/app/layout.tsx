...
export const metadata: Metadata = {
  ...
  description:
    "Email marketer specializing in Klaviyo, lifecycle marketing, and email deliverability. $1.5M+ revenue generated, 1.2M+ subscribers managed, 100+ clients served.",
};
